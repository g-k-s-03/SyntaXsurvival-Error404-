...
class OtpRateLimit(Base):
    ...
    key_type: Mapped[OtpKeyType] = mapped_column(SAEnum(OtpKeyType, name="otp_key_type"), nullable=False)
    ...
    resend_available_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
